...
export const SERIES = [
  ...
  },
  {
    ...
    format: 'trillions', unit: '$T', freq: 'Quarterly',
    group: 'macro',
  },
  {
    id: 'RSXFS',
  ...
  },
  {
    ...
    format: 'thousands', unit: 'K persons', freq: 'Weekly',
    group: 'labor',
  },
  {
    id: 'CES0500000003',
...
export function formatValue(val, format) {
  ...
  if (format === 'millions') return val.toFixed(2) + 'M';
...
export function formatChange(chg, format) {
  ...
  else if (format === 'millions') text = sign + chg.toFixed(2) + 'M';
